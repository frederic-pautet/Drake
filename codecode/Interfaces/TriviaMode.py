...
def start_trivia_snake_game():
    ...
    def charger_questions():
        with open('database/questions.json','r',encoding='utf_8') as file :
    ...
    def tache():
        ...
        if not PERDU:
            ...
            submit_button = Button(fenetre_perdu, text="Submit", command=submit_name, bg="lightyellow")
            submit_button.pack(pady=10)


            Button(fenetre_perdu, text="Rejouer", bg="lightgreen", command=lambda: [fenetre_perdu.destroy(), fenetre.destroy(), start_trivia_snake_game()]).pack(pady=10)
    ...
    reinitialiser_jeu()  # Réinitialiser le jeu avant de commencer
