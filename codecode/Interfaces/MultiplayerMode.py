...
def start_multiplayer_snake_game(speed, control_scheme):
    fenetre = Tk()
    game = MultiplayerSnakeGame(fenetre, speed, control_scheme)

class MultiplayerSnakeGame:
    def __init__(self, fenetre, speed, control_scheme):
    ...
    def show_result(self):
        ...
        # Button play again
        Button(result_window, text="Play again", bg="lightgreen", command=lambda: [result_window.destroy(), start_multiplayer_snake_game(selected_speed="Medium", control_scheme='ZQSD')]).pack(pady=20)
...
if __name__ == "__main__":
    fenetre = Tk()
    game = MultiplayerSnakeGame(fenetre, 'Fast', 'ZQSD')
